...
2. Git clone the course material in RStudio: `File` -> `New Project...` -> `Version Control` -> `Git`. Enter `https://github.com/ucla-biostat-200c/2026spring.git` in the `Repository URL` and click `Create Project`. 
