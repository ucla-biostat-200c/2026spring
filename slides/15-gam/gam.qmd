...
This does not mean the smooth is literally a subject-specific random effect. It means the algebra is the same: a wiggliness penalty can be represented as a random-effect variance.
:::
