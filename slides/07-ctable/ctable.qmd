...
### Poisson sampling: no margins are fixed

| Particle | Good | Bad | Total |
|---|---:|---:|---:|
| No  | ? | ? | ? |
| Yes | ? | ? | ? |
| **Total** | ? | ? | ? |

### Multinomial sampling: only the grand total is fixed
...
### Product binomial sampling: row totals are fixed
...
### Hypergeometric sampling: row and column totals are fixed

| Particle | Good | Bad | Total |
|---|---:|---:|---:|
| No  | ? | ? | **400 fixed** |
| Yes | ? | ? | **50 fixed** |
| **Total** | **334 fixed** | **116 fixed** | **450 fixed** |
